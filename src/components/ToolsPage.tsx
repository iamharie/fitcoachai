  ...
  const apps = [
    {
      ...
      description:
        "The best strength training app for tracking workouts, sets, reps, and progressive overload.",
    ...
    },
    {
      ...
      description:
        "Comprehensive calorie and macro tracking with the largest food database available.",
    ...
    },
    {
      ...
      description:
        "AI-powered health coach for Indian cuisine with personalized meal plans and coaching.",
  ...
  const gears = [
    {
      ...
      description:
        "Premium leather lifting belt for core support during heavy squats and deadlifts.",
    ...
    },
    {
      ...
      description:
        "Professional-grade waist tapper belt for maximum support during competition lifts.",
    ...
    },
    {
      ...
      description:
        "Heavy-duty lifting straps for improved grip strength during deadlifts and rows.",
      icon: <FaDumbbell className="h-8 w-8" />,
    ...
    },
    {
      ...
      description:
        "Elastic knee wraps for additional support and stability during heavy squats.",
    ...
    },
    {
      ...
      description:
        "Classic flat-soled shoes perfect for deadlifts and squats with stable base.",
      icon: <FaWeight className="h-8 w-8" />,
  ...
  const supplements = [
    {
      ...
      category: "Protein",
      description:
        "High-quality whey protein for muscle recovery and growth. Essential post-workout nutrition.",
    ...
    },
    {
      ...
      description:
        "Most researched supplement for strength, power, and muscle mass gains.",
      icon: <HiLightningBolt className="h-8 w-8" />,
    ...
    },
    {
      ...
      category: "Health",
      description:
        "Comprehensive vitamin and mineral support for overall health and recovery.",
      icon: <FaHeart className="h-8 w-8" />,
        ...
        return (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {apps.map((app, index) => (
              <div
                key={index}
                className="group bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-2xl border border-gray-100 dark:border-gray-700 hover:shadow-3xl transition-all duration-300 transform hover:-translate-y-4"
              >
                <div className="flex items-center justify-between mb-6">
                  <div
                    className={`bg-gradient-to-r ${app.color} w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
                    {app.icon}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {gears.map((item, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <div
                    className={`bg-gradient-to-r ${item.color} w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
                    {item.icon}
                  </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {supplements.map((supplement, index) => (
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <div
                    className={`bg-gradient-to-r ${supplement.color} w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-lg group-hover:scale-110 transition-transform duration-300`}
                  >
                    {supplement.icon}
                  </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Discover the apps, equipment, and supplements I personally use and
            recommend to optimize your fitness journey. These tools have been
            game-changers in my training!
          </p>
        </div>
        ...
        <div className="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900 dark:to-orange-900 border border-yellow-200 dark:border-yellow-700 rounded-3xl p-8">
          <div className="text-center">
            ...
            <p className="text-gray-700 dark:text-gray-300 leading-relaxed max-w-4xl mx-auto">
              These recommendations are based on my personal experience and
              research. Always consult with healthcare professionals before
              starting any new supplement regimen. Individual results may vary,
              and what works for me might not work for everyone. Do your own
              research and make informed decisions about your health and fitness
              journey.
            </p>
          </div>
        </div>
