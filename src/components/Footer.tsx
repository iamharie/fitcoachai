        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <div className="flex items-center gap-1 mt-1">
                  ...
                  <span className="text-sm text-blue-300 font-semibold">Powered by AI</span>
                </div>
              </div>
            </div>
            <p className="text-gray-300 mb-8 max-w-md leading-relaxed text-lg">
              Your personal AI nutritionist and fitness companion. Calculate your calories, get personalized meal plans, 
              and discover the tools that will transform your fitness journey. 
              <span className="text-cyan-400 font-bold">Completely free, forever!</span>
            </p>
            <div className="flex space-x-4">
              <a
                href="https://instagram.com/fitcoach.ai"
                target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="#home" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center gap-2 group">
                  <FaRocket className="h-4 w-4 group-hover:text-cyan-400 transition-colors duration-300" />
                  Home
                </a>
              </li>
              <li>
                <a href="#calorie-calculator" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center gap-2 group">
                  <HiSparkles className="h-4 w-4 group-hover:text-cyan-400 transition-colors duration-300" />
                  Calorie Calculator
                </a>
              </li>
              <li>
                <a href="#meal-planner" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center gap-2 group">
                  <FaRocket className="h-4 w-4 group-hover:text-cyan-400 transition-colors duration-300" />
                  AI Meal Planner
                </a>
              </li>
              <li>
                <a href="#tools" className="text-gray-300 hover:text-white transition-colors duration-300 flex items-center gap-2 group">
                  <HiSparkles className="h-4 w-4 group-hover:text-cyan-400 transition-colors duration-300" />
                  My Tools
                </a>
              </li>
          ...
          {/* Contact & CTA */}
          <div>
            <h3 className="text-xl font-bold mb-6 text-blue-300">Get Started</h3>
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <FaEnvelope className="h-5 w-5 text-blue-400" />
                <span className="text-gray-300">coach@fitcoach.ai</span>
              </div>
              <div className="flex items-center space-x-3">
                <FaInstagram className="h-5 w-5 text-pink-400" />
                <span className="text-gray-300">@fitcoach.ai</span>
              </div>
            </div>
            
            <div className="mt-8">
              <h4 className="text-lg font-bold mb-3 text-white">Ready to Transform?</h4>
