...
const Hero: React.FC<HeroProps> = ({ onGetStarted }) => {
  ...
  return (
    <div className="relative min-h-screen pt-20 bg-gradient-to-br from-blue-900 via-indigo-800 to-purple-700 dark:from-gray-900 dark:via-blue-900 dark:to-indigo-900 flex items-center justify-center overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-12 leading-relaxed max-w-4xl mx-auto">
            Calculate your daily calorie needs, generate personalized meal plans
            with AI, and discover the tools that will transform your fitness
            journey.
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <button
              ...
              className="group bg-gradient-to-r from-cyan-400 to-blue-500 text-black px-10 py-5 rounded-full font-bold text-xl hover:from-cyan-300 hover:to-blue-400 transform hover:scale-105 transition-all duration-300 shadow-2xl flex items-center justify-center gap-3 relative overflow-hidden"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-20 mb-20">
            ...
            <div className="group bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-4 hover:shadow-2xl">
              ...
              <p className="text-blue-100">
                Personalized nutrition plans generated by advanced AI based on
                your calorie needs and preferences
              </p>
            </div>
            ...
            <div className="group bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-4 hover:shadow-2xl">
              ...
              <p className="text-blue-100">
                Discover the apps, gear, and supplements I use to optimize my
