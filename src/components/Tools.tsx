...
const Tools = () => {
  ...
  return (
    <div className="py-20 bg-gradient-to-br from-cyan-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-cyan-900 dark:to-blue-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-6">
            <HiSparkles className="h-8 w-8 text-cyan-600 dark:text-cyan-400 mr-3 animate-pulse" />
            <h2 className="text-5xl md:text-6xl font-black bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 bg-clip-text text-transparent">
              My Fitness Arsenal
            </h2>
        ...
        <div className="mb-20">
          <div className="flex items-center justify-center mb-12">
            <FaMobile className="h-8 w-8 text-blue-600 dark:text-blue-400 mr-3" />
            <h3 className="text-4xl font-bold text-gray-900 dark:text-white">Essential Apps</h3>
          </div>
        ...
        {/* Training Gears Section */}
        <div className="mb-20">
          <div className="flex items-center justify-center mb-12">
            <FaDumbbell className="h-8 w-8 text-indigo-600 dark:text-indigo-400 mr-3" />
            <h3 className="text-4xl font-bold text-gray-900 dark:text-white">Training Gears</h3>
          </div>
        ...
        <div>
          <div className="flex items-center justify-center mb-12">
            <FaPills className="h-8 w-8 text-green-600 dark:text-green-400 mr-3" />
            <h3 className="text-4xl font-bold text-gray-900 dark:text-white">Recommended Supplements</h3>
          </div>
        ...
        {/* Disclaimer */}
        <div className="mt-16 bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-yellow-900 dark:to-orange-900 border border-yellow-200 dark:border-yellow-700 rounded-3xl p-8">
